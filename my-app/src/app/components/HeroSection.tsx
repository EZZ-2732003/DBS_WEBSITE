  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="اكتشف منصة تعليمية متخصصة في تنمية المهارات العقلية والحساب الذهني للأطفال من سن 4 إلى 18 عامًا. انضم إلينا الآن!"
        />
        <meta
          name="keywords"
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 text-white relative overflow-hidden">
        ...
        <p className="text-xl mb-12 text-center z-10 text-shadow">
          منصة تعليمية مخصصة للأطفال من سن 4 إلى 18 عامًا
        </p>
